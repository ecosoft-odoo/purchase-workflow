...
from odoo.addons.purchase_invoice_plan.tests import test_purchase_invoice_plan


class TestPurchaseInvoicePlanDeposit(
    test_purchase_invoice_plan.TestPurchaseInvoicePlan
):
    def setUp(self):
        super(TestPurchaseInvoicePlanDeposit, self).setUp()
